...
def get_trending_repositories(reps_amount, days_interval, api_url):
    ...
    return repositories_info["items"][:reps_amount]
...
if __name__ == '__main__':
    repositories = get_trending_repositories(REPS_AMOUNT, DAYS_INTERVAL, API_URL)
